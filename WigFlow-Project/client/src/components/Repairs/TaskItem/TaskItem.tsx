...
// הגדרת הממשק (Interface) של המשימה כפי שתחזור מהשרת
    ...
    <div style={cardStyle}>
      <div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
          ...
          {task.isUrgent && (
            <span style={{ backgroundColor: '#dc3545', color: 'white', padding: '2px 8px', borderRadius: '12px', fontSize: '12px', fontWeight: 'bold' }}>
              דחוף!
            </span>
          )}
        </div>
        ...
        {task.notes && (
          <p style={{ margin: '8px 0 0 0', padding: '8px', backgroundColor: '#f8f9fa', borderRadius: '4px', fontSize: '14px', color: '#666', borderRight: '3px solid #6f42c1' }}>
